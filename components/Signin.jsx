...
const Signin = ({ onClose }) => {
    ...
    return (
        ...
        <div className="  bg-black bg-opacity-25 backdrop-blur-sm min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 " >
            <div className="max-w-md w-full bg-white rounded-[25px] shadow-lg overflow-hidden">
                ...
                <form onSubmit={handleSubmit} className="mt-8 space-y-4">
                    ...
                    <div className="px-8 mt-6">
                        <button className="w-full py-3 px-4 border border-transparent text-sm font-medium rounded-full text-black  bg-white hover:bg-gray-300 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-600 border-red-400">Нэвтрэх</button>
                    </div>
                    <div className="px-8 mt-4">
                        <button className="w-full py-3 px-4 border border-transparent text-sm font-medium rounded-full text-black bg-white hover:bg-gray-300  hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-600 border-red-400">Бүртгүүлэх</button>
                    </div>
            ...
            {showSignin && <Signin onClose={handleWrapperClick} />}
        </div>
